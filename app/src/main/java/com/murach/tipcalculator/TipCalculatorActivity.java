...
implements OnEditorActionListener, OnClickListener {
    ...
    public void onClick(View v) {
        ...
        case R.id.saveButton:
        	// create an insert tip
        	Tip tip = new Tip();
            if (billAmountString.equals("")) billAmountString = "0";
        	tip.setBillAmount(Float.parseFloat(billAmountString));
        	...
        	Toast.makeText(getApplicationContext(), "Tip Saved", Toast.LENGTH_SHORT).show();
            break;
        case R.id.viewHistoryButton:
        	// start activity here...
            Toast.makeText(getApplicationContext(),"Open Tip History", Toast.LENGTH_SHORT).show();
